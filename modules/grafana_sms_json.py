        ...
        for key, value in postvars.items():
            ...
            with open('/home/sms/txt/mtn.txt') as f:
                 for lines in iter(lambda: tuple(islice(f, n)), ()):  
                    ...
                    for msisdn in num:
                        url = 'http://192.168.2.204:12003/mtn/sms?from_addr=*904&to_addr=%2B{0}&content={1}'.format(msisdn,message)
